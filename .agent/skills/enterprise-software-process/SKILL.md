---
name: enterprise-software-process
...
```
.agent/skills/enterprise-software-process/
...
當 Agent 偵測到與企業軟體開發流程相關的任務時，將自動參考此 skill 系統的相關指引。
