  ...
  return (
    <div className="space-y-stack-sm sm:space-y-stack-md">
      ...
      <div className="bg-white p-component-base sm:p-component-md-lg rounded-lg shadow-md">
        <h2 className="text-body-lg sm:text-h2 font-semibold mb-4 text-gray-700">班級概況</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-stack-sm">
          <div className="bg-gradient-to-r from-teal-500 to-cyan-600 p-component-base rounded-lg text-white">
            <h3 className="text-body-sm font-medium mb-2">學習進度分佈</h3>
          ...
          <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-component-base rounded-lg text-white">
            <h3 className="text-body-sm font-medium mb-2">活動統計</h3>
            <div className="space-y-1">
              <div className="flex justify-between text-caption">
                <span>看板任務</span>
          ...
          <div className="bg-gradient-to-r from-green-500 to-emerald-600 p-component-base rounded-lg text-white">
            <h3 className="text-body-sm font-medium mb-2">專案狀態</h3>
            <div className="space-y-1">
              <div className="flex justify-between text-caption">
                <span>總專案數</span>
      ...
      {/* 最近活動 */}
      <div className="bg-white p-component-base sm:p-component-md-lg rounded-lg shadow-md">
        <h2 className="text-body-lg sm:text-h2 font-semibold mb-4 text-gray-700">最近活動</h2>
        <div className="space-y-3 max-h-80 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-customgreen scrollbar-track-gray-50" 
          ...
          {(() => {
            ...
            return sortedActivities.map((activity, index) => (
              <div key={index} className="flex items-center space-x-3 p-component-sm bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                <span className="text-body-lg">{activity.icon}</span>
