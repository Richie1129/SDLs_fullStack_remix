  ...
  return (
    <div className="bg-white p-3 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
      ...
      <div className="space-y-4">
        <div className="bg-gradient-to-r from-teal-50 to-customgreen/10 p-3 sm:p-4 rounded-lg border border-teal-100 hover:border-teal-200 transition-colors duration-300">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-3 space-y-1 sm:space-y-0">
            <span className="font-semibold text-gray-800 text-sm sm:text-base">{personalData?.projectName || '專案'}</span>
            <span className="text-xs sm:text-sm text-teal-600 bg-teal-100 px-2 py-1 rounded-full font-medium">第 {personalData?.currentStage || 1} 階段</span>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          <div className="bg-gradient-to-br from-teal-50 to-teal-100/50 p-3 sm:p-4 rounded-lg border border-teal-200 hover:border-teal-300 transition-all duration-300 hover:shadow-md">
            <h3 className="font-semibold text-teal-800 mb-3 text-sm sm:text-base flex items-center">
              <span className="w-8 h-8 bg-teal-500 text-white rounded-full flex items-center justify-center text-xs mr-2">📊</span>
              學習統計
            </h3>
          ...
          <div className="bg-gradient-to-br from-customgreen/20 to-teal-100/50 p-3 sm:p-4 rounded-lg border border-customgreen/30 hover:border-customgreen/50 transition-all duration-300 hover:shadow-md">
            <h3 className="font-semibold text-teal-800 mb-3 text-sm sm:text-base flex items-center">
              <span className="w-8 h-8 bg-customgreen text-white rounded-full flex items-center justify-center text-xs mr-2">📋</span>
              任務狀況
            </h3>
            <div className="space-y-3 text-xs sm:text-sm">
              <div className="flex justify-between items-center">
              ...
              {personalData?.allColumnNames && Array.isArray(personalData.allColumnNames) && personalData.allColumnNames.length > 0 ? (
                ...
                <div className="text-center py-3 bg-white/50 rounded-lg">
                  <span className="text-teal-600 text-xs font-medium">🎯 準備開始建立任務吧！</span>
                </div>
              )}
            </div>
          </div>
