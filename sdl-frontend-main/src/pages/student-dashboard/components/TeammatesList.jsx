  ...
  return (
    <div className="bg-white p-3 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
      ...
      <div className="space-y-3 sm:space-y-4">
        <div className="bg-gradient-to-r from-customgreen/10 to-teal-50 p-3 rounded-lg border border-teal-100 hover:border-teal-200 transition-colors duration-300">
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-gradient-to-br from-customgreen to-teal-600 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 shadow-sm">
              我
            </div>
            ...
            <div className="flex-shrink-0">
              <span className="text-xs bg-gradient-to-r from-customgreen to-teal-600 text-white px-3 py-1 rounded-full font-semibold shadow-sm">
        ...
        {Array.isArray(teammates) && teammates.length > 0 ? (
          teammates.map((teammate, index) => (
            <div key={index} className="bg-gradient-to-r from-gray-50 to-gray-100/50 p-3 rounded-lg border border-gray-200 hover:border-gray-300 transition-colors duration-300">
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-gradient-to-br from-gray-400 to-gray-500 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 shadow-sm">
