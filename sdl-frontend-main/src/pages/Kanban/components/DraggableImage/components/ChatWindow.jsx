...
const ChatWindow = ({
  ...
  if (isFullscreen) {
    containerClassName = 'chat-container fixed w-screen h-[100dvh] rounded-none shadow-none z-fullscreen bg-white flex flex-row transition-all duration-normal ease-in-out';
