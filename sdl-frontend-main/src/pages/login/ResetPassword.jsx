...
export default function ResetPassword() {
  ...
  if (!isValidToken) {
    return (
      <section className="flex flex-col md:flex-row h-screen items-center justify-center">
        <div className="bg-white w-full max-w-md rounded-lg p-8 shadow-2xl text-center">
          <div className="mb-6">
            <svg className="w-16 h-16 text-red-500 mx-auto mb-4" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
            </svg>
            <h1 className="text-2xl font-bold text-gray-800 mb-2">連結無效</h1>
          ...
          <Link
            ...
            className="inline-block text-white font-semibold rounded-lg px-6 py-3 text-base"
          >
            重新請求密碼重設
          </Link>
        </div>
      ...
      <section className="flex flex-col md:flex-row h-screen items-center justify-center">
        <div className="bg-white w-full max-w-md rounded-lg p-8 shadow-2xl text-center">
          <div className="mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-2">密碼重設成功！</h1>
    ...
    <section className="flex flex-col md:flex-row h-screen items-center">
      ...
      <div className="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-1/2 h-screen lg:px-36 xl:px-40 flex items-center justify-center">
        <div className="bg-white w-full h-100 rounded-lg p-8 shadow-2xl">
          ...
          <h1 className="text-4xl font-bold mb-6 flex items-center justify-center">重設密碼</h1>
          ...
          <form className="mt-6" onSubmit={handleSubmit}>
            <div className="mb-4">
              <label className="block text-gray-700 text-base">新密碼</label>
              <input
                type="password"
                name="newPassword"
            ...
            <div className="mb-4">
              <label className="block text-gray-700 text-base">確認新密碼</label>
              <input
                type="password"
            ...
            <button
              ...
              style={{ backgroundColor: "#5BA491" }}
              className="w-full block text-white font-semibold rounded-lg px-4 py-3 text-base disabled:opacity-50 disabled:cursor-not-allowed"
            >
