...
export default function StudentPortfolio() {
  ...
  const doExport = async () => {
    ...
    try {
      ...
      const studentName = portfolioData?.student?.username || 'portfolio';
      const projectName = portfolioData?.project?.name || '';

      await html2pdf().set({
        margin: 0,
        filename: `學習歷程_${studentName}_${projectName}_${new Date().toISOString().split('T')[0]}.pdf`,
        image: { type: 'jpeg', quality: 0.95 },
        html2canvas: { scale: 2, useCORS: true, allowTaint: true, windowWidth: 794, scrollX: 0, scrollY: 0 },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-component-md py-component-md">
        ...
        {/* AI 生成錯誤 */}
        {generateError && (
          <div className="mb-4 p-3 bg-red-50 border border-red-100 rounded-lg text-body-sm text-red-600">
            AI 生成失敗：{generateError}
          </div>
        )}

        {/* 模板選擇器 */}
        <div className="bg-white rounded-xl border border-gray-200 p-component-md mb-component-md">
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
          <div className="px-component-md py-3 border-b border-gray-100 flex items-center justify-between">
            <span className="text-body-sm text-gray-500">預覽（實際 PDF 以 A4 紙張輸出）</span>
          ...
          <div className="overflow-auto p-4 bg-gray-100">
            {/* 固定 A4 寬度，確保 html2canvas 捕捉範圍精確等於 PDF 頁面寬度 */}
