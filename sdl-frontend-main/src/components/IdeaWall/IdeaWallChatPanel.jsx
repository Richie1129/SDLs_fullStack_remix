        ...
        >
                ...
                <div className="flex flex-col">
                    ...
                    {filterNodeId && (
                        <button 
                            ...
                            className="text-caption text-teal-200 hover:text-white text-left underline mt-1"
                        >
                            切換回全域模式
                        </button>
                    )}
            ...
            {!filterNodeId && (
                showContext ? (
                    <>
                        {contextLoading ? (
                            <div className="bg-customgreen/10 p-component-sm border-b border-customgreen/20 relative">
                                <button 
                            ...
                            <div className="bg-customgreen/10 p-component-sm border-b border-customgreen/20 relative">
                                ...
                                <div className="flex items-start space-x-stack-xs">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-caption text-teal-700 leading-relaxed">
                                            {wallContext.summary}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="bg-customgreen/10 p-component-sm border-b border-customgreen/20 flex justify-between items-center">
                                ...
                                <button 
                                    ...
                                    className="text-caption bg-customgreen hover:bg-teal-600 text-white px-3 py-1 rounded shadow-sm transition-colors"
                                >
                                    生成報告
                                </button>
                            </div>
                    ...
                    <div className="bg-customgreen/10 p-component-xs border-b border-customgreen/20 flex justify-between items-center">
                        <span 
                        ...
                        <button 
                            ...
                            className="text-caption bg-customgreen/20 hover:bg-customgreen/30 text-teal-800 px-2 py-1 rounded transition-colors flex items-center"
            ...
            {/* Messages Area */}
            <div className="flex-1 overflow-y-auto p-component-sm bg-customgreen/5 space-y-3 scrollbar-thin">
                {messages.length === 0 ? (
                    <div className="text-center text-gray-400 text-body-sm mt-10">
                        尚無討論訊息
                    </div>
                ) : (
                    messages.map((msg) => (
                        <div key={msg.id} className={`flex flex-col ${msg.isSelf ? "items-end" : "items-start"}`}>
                            ...
                            <div 
                                className={`max-w-[85%] rounded-lg p-component-xs text-body-sm shadow-sm 
            ...
            {/* Input Area */}
            <form onSubmit={handleSend} className="p-component-sm bg-white border-t border-gray-200">
                <div className="flex items-center space-x-stack-xs">
                    <input
                        type="text"
                        value={inputValue}
                        ...
                        className="flex-1 border border-gray-300 rounded-full px-4 py-2 text-body-sm focus:outline-none focus:ring-2 focus:ring-customgreen focus:border-transparent"
                        disabled={loading}
                    />
                    <button 
                        type="submit" 
                        disabled={loading || !inputValue.trim()}
                        className={`p-component-xs rounded-full ${loading || !inputValue.trim() ? 'bg-gray-300 cursor-not-allowed' : 'bg-customgreen hover:bg-teal-600 text-white shadow-md'}`}
                    >
