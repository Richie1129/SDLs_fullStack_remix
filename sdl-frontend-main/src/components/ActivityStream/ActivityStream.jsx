...
const ActivityStream = ({ projectId, isOpen, onClose }) => {
    ...
    return (
        <motion.div
            {...DRAWER_RIGHT}
            className="fixed right-0 top-16 h-[calc(100dvh-7rem)] sm:h-[calc(100dvh-7.5rem)] lg:h-[calc(100dvh-8rem)] w-72 sm:w-80 lg:w-96 bg-white shadow-xl border-l border-gray-200 z-drawer overflow-hidden"
        >
            {/* 標題列 */}
