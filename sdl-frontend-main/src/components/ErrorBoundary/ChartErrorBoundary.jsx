...
class ChartErrorBoundary extends React.Component {
  ...
  renderFallbackChart = () => {
    ...
    if (chartType === 'bar' && Array.isArray(data)) {
      return (
        <div className="w-full h-64 bg-gray-50 rounded-lg border-2 border-dashed border-gray-200 flex flex-col items-center justify-center p-4">
          <div className="text-gray-600 mb-4">
            <svg className="w-8 h-8 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
          </div>
          <h3 className="text-sm font-medium text-gray-700 mb-2">{title || '圖表數據'}</h3>
    ...
    return (
      <div className="w-full h-64 bg-gray-50 rounded-lg border-2 border-dashed border-gray-200 flex flex-col items-center justify-center p-4">
        ...
        <h3 className="text-sm font-medium text-gray-700 mb-2">{title || '圖表顯示'}</h3>
  ...
  render() {
    if (this.state.hasError) {
        ...
        return (
          <div className="relative">
            ...
            {process.env.NODE_ENV === 'development' && (
              <details className="mt-2 p-2 bg-red-50 rounded border border-red-200 text-left">
      ...
      // 預設錯誤顯示
      return (
        <div className="w-full h-32 bg-red-50 rounded-lg border border-red-200 flex items-center justify-center p-4">
          <div className="text-center">
            ...
            <p className="text-red-700 text-sm font-medium">圖表載入失敗</p>
            <button
              onClick={this.handleRetry}
