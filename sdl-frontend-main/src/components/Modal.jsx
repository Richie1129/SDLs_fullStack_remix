        ...
        <>
            {
                ...
                <div onClick={(e) => e.stopPropagation()} className={`bg-white rounded-md shadow p-component-sm sm:p-component-md transition-all duration-normal ${scrollClass} ${custom ? custom : "w-[95vw] sm:w-4/5 lg:w-2/5 max-w-2xl"} ${open ? "scale-100 opacity-100" : "scale-75 opacity-0"}`} >
                    {children}
                    </div>
                </div> 
            }
