        ...
        <>
            {
                ...
                <div onClick={(e) => e.stopPropagation()} className={` bg-white rounded-md shadow transition-all duration-300 max-h-[90vh] overflow-y-auto ${custom ? custom : "w-11/12 sm:w-3/4 lg:w-1/3"} ${open ? "scale-100 opacity-100" : "scale-75 opacity-0"}`} >
                ...
                <div onClick={(e) => e.stopPropagation()} className={` bg-white rounded-md shadow px-4 sm:px-8 lg:px-16 py-4 sm:py-6 lg:py-8 transition-all duration-300 max-h-[90vh] overflow-y-auto ${custom ? custom : "w-11/12 sm:w-3/4 lg:w-1/3"} ${open ? "scale-100 opacity-100" : "scale-75 opacity-0"}`} >
                    {children}
                    </div>
                </div> 
            }
